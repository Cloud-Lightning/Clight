...
/* For bring-up, always sync flash-emulated EEPROM to the SSC-generated eeprom.h content. */
#define ECAT_EEPROM_FORCE_INIT                           (1)
/* Temporary bring-up mode: expose mailbox only and allow empty SM2/SM3. */
#define ECAT_TEMP_MAILBOX_ONLY                           (0)
