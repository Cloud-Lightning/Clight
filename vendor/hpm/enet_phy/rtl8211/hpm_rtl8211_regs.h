...
typedef enum {
    ...
    RTL8211_PAGE_SELECT                 = 31,  /* 0x1F: Page Select Register (RTL8211F) */
} RTL8211_REG_Type;

/* RTL8211F paged register access */
#define RTL8211F_PHYSR1_PAGE                 (0xA43U)
#define RTL8211F_PHYSR1_REG                  (0x1AU)
...
/* RTL8211F PHYSR bit definitions (Page 0xA43, Address 0x1A, bit layout differs from RTL8211E) */
#define RTL8211F_PHYSR_SPEED_MASK            (0x30U)
...
#define RTL8211F_PHYSR_DUPLEX_MASK           (0x8U)
...
#define RTL8211F_PHYSR_LINK_REAL_TIME_MASK   (0x4U)
